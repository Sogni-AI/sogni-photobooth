...
const createDefaultSettings = (): Settings => {
  ...
  return {
    ...
    videoTransitionPrompt: 'Cinematic transition shot that connects the starting frame reference image to the ending frame reference image. Preserve the same subject identity and facial structure. Use a premium artistic transition or transformation allow existing elements and environment to morph smoothly; keep the final reveal sharp, stable, and cinematic with restrained optical character, subtle anamorphic flare, fine film grain, controlled contrast', // Prompt for transition videos
  };
};
