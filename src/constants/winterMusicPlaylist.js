...
// Winter event music playlist
// Note: URLs are properly encoded to handle spaces in filenames
export const WINTER_PLAYLIST = [
  {
    url: `${urls.assetUrl}/music/Winter%2002%20-%20This%20Season%20(Sogni%20Winter%20Theme).mp3`,
    title: 'This Season 🤗 (Winter Booth Theme)'
  },
  {
  ...
  },
  {
    ...
    title: 'Trapped in the Photobooth Part 1'
  },
  {
